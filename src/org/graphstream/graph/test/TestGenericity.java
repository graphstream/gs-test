...
public class TestGenericity
{
	...
	protected static class MyConcurrentNode
		extends ConcurrentNode
	{
	...
	protected static class MyConcurrentNodeFactory
		implements NodeFactory<MyConcurrentNode>
	{
	...
	protected static class MyConcurrentEdge
		extends ConcurrentEdge
	{
		protected MyConcurrentEdge(String id, Node src, Node dst, boolean directed)
		{
			super(id, src, dst, directed);
		}
	}
	
	protected static class MyConcurrentEdgeFactory
		implements EdgeFactory<MyConcurrentEdge>
	{
