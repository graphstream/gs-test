...
// Test
	...
	public void test_Access_ReadAll_Reader()
	{
		try
		{
			...
			source.readAll( new StringReader( anUndirectedTriangle() ) );
	...
	public void test_Access_ByStep_Reader()
	{
		...
		{
			source.addGraphListener( graph );
			source.begin( new StringReader( anUndirectedTriangle() ) );
	...
	public void test_Access_ReadAll_Stream()
	{
		...
		{
			source.addGraphListener( graph );
			source.readAll( new FileInputStream( anUndirectedTriangleFileName() ) );
			undirectedTriangleTests();
		}
		catch( IOException e )
		{
	...
	public void test_Access_ReadAll_FileName()
	{
		...
		{
			source.addGraphListener( graph );
			source.readAll( anUndirectedTriangleFileName() );
			undirectedTriangleTests();
		}
		catch( IOException e )
		{
	...
	public void test_DirectedTriangle()
	{
		...
		{
			source.addGraphListener( graph );
			source.readAll( new StringReader( aDirectedTriangle() ) );
	...
	public void test_Attributes()
	{
		...
		{
			source.addGraphListener( graph );
			source.readAll( new StringReader( basicAttributes() ) );
